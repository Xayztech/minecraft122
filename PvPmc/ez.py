...
<html>
<head>
<title>Minecraft - Xayz Tech Drive (XYCoolcraft Drive)</title>
...
window.addEventListener("load", function() {
                            ...
                            window.eaglercraftOpts = {
                                    ...
                                    "Minecraft!", "XYCoolcraft!", "Long live Indonesia!", "Yeeeeeee!", "yeee",
                                    "EEEEEEEEE!", "GG Day!", "You handsome!", ":>", "|>", "You Player not a robot!"
